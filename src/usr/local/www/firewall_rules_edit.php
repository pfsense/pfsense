...
foreach (['src' => 'Source', 'dst' => 'Destination'] as $type => $name) {
	...
	$group->setHelp(sprintf(gettext('Specify the %s port or port range for this rule. The "To" field may be left empty if only filtering a single port.'), strtolower($name)));
