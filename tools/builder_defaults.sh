...
if [ -z "${MODULES_OVERRIDE}" ]; then
	...
	export MODULES_OVERRIDE_amd64="${MODULES_OVERRIDE_armv6} aesni amdtemp amdsmn coretemp cpuctl drm2 ena ichwd ipmi i2c/controllers/ismt ix ixv linuxkpi ndis nmdm sfxge udf vmm sg5100"
...
export PFSENSE_DEFAULT_REPO="${PRODUCT_NAME}-repo-244"
