...
export MODULES_OVERRIDE=${MODULES_OVERRIDE:-"cryptodev i2c ichwd ipmi ndis ipfw ipdivert dummynet fdescfs opensolaris zfs if_stf coretemp amdtemp aesni sfxge hwpmc vmm nmdm ix ixv udf"}
