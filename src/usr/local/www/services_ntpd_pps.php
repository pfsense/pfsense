...
$section->addInput(new Form_StaticText(
	...
	sprintf(
		_(
			...
			. 'At least 3 additional time sources should be configured under <a href="services_ntpd.php">Services > NTP > Settings</a> to reliably supply the time of each PPS pulse.'
		)
	)
));
