...
<div class="panel panel-default">
		<div class="panel-heading"><h2 class="panel-title"><?=htmlspecialchars($server['name']);?> <?=gettext('Client Connections') . ": "?>  <? if ($server['conns'][0]['common_name'] != '[error]'): echo sizeof($server['conns']); endif; ?></h2></div>
