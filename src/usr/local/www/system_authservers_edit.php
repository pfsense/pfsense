...
$act = (isset($id) && $a_server[$id]) ? 'edit' : 'new';
...
if ($act == "edit") {
	...
	// $act == "new"
	unset ($id); // if an invalid id was passed with "edit", it's treated as "new" and unset $id "just in case" to avoid confusion
...
$pgtitle = array(gettext("System"), gettext("User Manager"), gettext("Authentication Servers"), gettext("Edit"));
$pglinks = array("", "system_usermanager.php", "system_authservers.php", "@self");
...
// $form->setAction('?act=edit');  // the presence of "id" in $_REQUEST will be enough. "act=" is ignored.
